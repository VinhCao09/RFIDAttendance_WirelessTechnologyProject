...
<body>
    ...
    <div class="main">
                ...
                <a class="mt-3">Register <span class="switch-form-link" onclick="showRegistrationForm()">Here.</span></a>
        ...
        <div class="registration-container">
            <div class="registration-form" id="registrationForm">
                <h2 class="text-center">Thêm QR code mới</h2>
                <p class="text-center">Điền thông tin cá nhân.</p>
                <form action="./endpoint/add-user.php" method="POST">
                    <div class="hide-registration-inputs">
                        ...
                        <div class="form-group registration row">
                            <div class="col-5">
                                <label for="contactNumber">SĐT:</label>
                        ...
                        <button type="button" class="btn btn-dark login-register form-control" onclick="generateQrCode()">Tạo QR Code</button>
                    </div>

                    <div class="qr-code-container text-center" style="display: none;">
                        <h3>Hãy lưu QR code này lại để sử dụng!</h3>
